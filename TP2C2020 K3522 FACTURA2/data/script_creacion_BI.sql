...
SELECT FAC_AUTO_CODIGO,faut.FACTURA_NRO,PRECIO_FACTURADO,FACTURA_FECHA
FROM GDD2020.FACTURA_AUTO faut
JOIN GDD2020.FACTURACION fac ON (faut.FACTURA_NRO = fac.FACTURA_NRO)

SELECT caut.COMPRA_NRO,COMPRA_PRECIO*COMPRA_CANT precioTotal
FROM GDD2020.COMPRA_AUTOMOVIL caut
JOIN GDD2020.COMPRA com ON (com.COMPRA_NRO = caut.COMPRA_NRO)
JOIN GDD2020.ITEM_COMPRA ic ON (ic.COMPRA_NRO = caut.COMPRA_NRO)

SELECT * FROM GDD2020.COMPRA_AUTOMOVIL ORDER BY COMPRA_NRO

SELECT * FROM GDD2020.ITEM_COMPRA ORDER BY COMPRA_NRO

SELECT c.COMPRA_NRO,COMPRA_PRECIO,COMPRA_CANT,COMPRA_PRECIO*COMPRA_CANT total
FROM GDD2020.COMPRA c
JOIN GDD2020.ITEM_COMPRA i ON (c.COMPRA_NRO = i.COMPRA_NRO)
JOIN GDD2020.COMPRA_AUTOMOVIL ca ON (ca.COMPRA_NRO = i.COMPRA_NRO)

SELECT c.COMPRA_NRO
FROM GDD2020.COMPRA c
JOIN GDD2020.COMPRA_AUTOMOVIL ca ON (c.COMPRA_NRO = ca.COMPRA_NRO)
