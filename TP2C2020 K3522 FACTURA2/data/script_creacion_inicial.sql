...
BEGIN
	...
	IF EXISTS (  SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[GDD2020].FK_CLIENTE_CODIGO_FACTURACION')  )
	ALTER TABLE [GDD2020].FACTURACION DROP CONSTRAINT FK_CLIENTE_CODIGO_FACTURACION
...
CREATE TABLE [GDD2020].[FACTURACION](
	...
	CONSTRAINT FK_CLIENTE_CODIGO_FACTURACION FOREIGN KEY (CLIENTE_CODIGO) REFERENCES [GDD2020].[CLIENTE](CLIENTE_CODIGO)
) ON [PRIMARY] --insertado
