...
--SELECT COUNT(*) automoviles FROM GDD2020.AUTOMOVIL
--SELECT COUNT(*) autopartes FROM GDD2020.AUTOPARTE
--SELECT COUNT(*) cajas FROM GDD2020.CAJA
--SELECT COUNT(*) clientes FROM GDD2020.CLIENTE
--SELECT COUNT(*) compras FROM GDD2020.COMPRA
--SELECT COUNT(*) compras_automovil FROM GDD2020.COMPRA_AUTOMOVIL
--SELECT COUNT(*) compras_autopartes FROM GDD2020.COMPRA_AUTOPARTE
--SELECT COUNT(*) fabricantes FROM GDD2020.FABRICANTE
--SELECT COUNT(*) facturas_auto FROM GDD2020.FACTURA_AUTO
--SELECT COUNT(*) facturas_autoparte FROM GDD2020.FACTURA_AUTOPARTE
--SELECT COUNT(*) facturaciones FROM GDD2020.FACTURACION
--SELECT COUNT(*) items_compra FROM GDD2020.ITEM_COMPRA
--SELECT COUNT(*) items_facturas FROM GDD2020.ITEM_FACTURA
--SELECT COUNT(*) modelos FROM GDD2020.MODELO
--SELECT COUNT(*) motores FROM GDD2020.MOTOR
--SELECT COUNT(*) sucursales FROM GDD2020.SUCURSAL
--SELECT COUNT(*) tipos_auto FROM GDD2020.TIPOAUTO
--SELECT COUNT(*) transmisiones FROM GDD2020.TRANSMISION
